...
{
    public abstract class Span_IndexOfNotEqualAll_EqualityComparer<T>
    {
    ...
    public class Span_IndexOfNotEqualAll_EqualityComparer_string : Span_IndexOfNotEqualAll_EqualityComparer<string>
    {
