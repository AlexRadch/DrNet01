...
{
    public abstract class Span_LastIndexOfNotEqualAll_EqualityComparer<T>
    {
    ...
    public class Span_LastIndexOfNotEqualAll_EqualityComparer_int : Span_LastIndexOfNotEqualAll_EqualityComparer<int>
    {
        public override int NewT(int value) => value;
    }

    public class Span_LastIndexOfNotEqualAll_EqualityComparer_string : 
        Span_LastIndexOfNotEqualAll_EqualityComparer<string>
    {
