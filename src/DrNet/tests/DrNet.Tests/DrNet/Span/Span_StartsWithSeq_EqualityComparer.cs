...
{
    public abstract class Span_StartsWithSeq_EqualityComparer<T>
    {
    ...
    public class Span_StartsWithSeq_EqualityComparer_int : Span_StartsWithSeq_EqualityComparer<int>
    {
        public override int NewT(int value) => value;
    }

    public class Span_StartsWithSeq_EqualityComparer_string : Span_StartsWithSeq_EqualityComparer<string>
    {
