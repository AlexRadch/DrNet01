...
{
    public abstract class Span_IndexOfEqualAny_EqualityComparer<T>
    {
    ...
    public class Span_IndexOfEqualAny_EqualityComparer_int: Span_IndexOfEqualAny_EqualityComparer<int>
    {
        public override int NewT(int value) => value;
    }

    public class Span_IndexOfEqualAny_EqualityComparer_string: Span_IndexOfEqualAny_EqualityComparer<string>
    {
