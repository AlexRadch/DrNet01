...
{
    public abstract class EqualsToSeq1<T, TSource, TValue>
    {
    ...
    public class EqualsToSeq1_intEE : EqualsToSeq1<int, TEquatable<int>, TEquatable<int>>
    {
    ...
    public class EqualsToSeq1_intEO : EqualsToSeq1<int, TEquatable<int>, TObject<int>>
    {
        public override int NewT(int value) => value;
        public override TEquatable<int> NewTSource(int value, Action<int, int> onCompare) =>
            new TEquatable<int>(value, onCompare);
    ...
    public class EqualsToSeq1_intOE : EqualsToSeq1<int, TObject<int>, TEquatable<int>>
    {
        public override int NewT(int value) => value;
    ...
    public class EqualsToSeq1_intOO : EqualsToSeq1<int, TObject<int>, TObject<int>>
    {
        public override int NewT(int value) => value;
        public override TObject<int> NewTSource(int value, Action<int, int> onCompare) =>
    ...
    public class EqualsToSeq1_stringEE : EqualsToSeq1<string, TEquatable<string>, TEquatable<string>>
    {
    ...
    public class EqualsToSeq1_stringEO : EqualsToSeq1<string, TEquatable<string>, TObject<string>>
    {
        public override string NewT(int value) => value.ToString();
        public override TEquatable<string> NewTSource(int value, Action<string, string> onCompare) =>
            new TEquatable<string>(value.ToString(), onCompare);
    ...
    public class EqualsToSeq1_stringOE : EqualsToSeq1<string, TObject<string>, TEquatable<string>>
    {
        public override string NewT(int value) => value.ToString();
    ...
    public class EqualsToSeq1_stringOO : EqualsToSeq1<string, TObject<string>, TObject<string>>
    {
        public override string NewT(int value) => value.ToString();
        public override TObject<string> NewTSource(int value, Action<string, string> onCompare) =>
