...
{
    public abstract class ReadOnlySpan_LastIndexOfNotEqualAll_EqualityComparer<T>
    {
        ...
        public void ZeroLength()
        {
            ...
            int idx = MemoryExt.LastIndexOfNotEqualAllSourceComparer(sp, values, EqualityComparer);
            Assert.Equal(-1, idx);
            idx = MemoryExt.LastIndexOfNotEqualAllSourceComparer(sp, values, EqualityComparer);
            Assert.Equal(-1, idx);
        ...
        public void DefaultFilled()
        {
            ...
            for (int length = 1; length < 100; length++)
            {
                ...
                int idx = MemoryExt.LastIndexOfNotEqualAllSourceComparer(span, values, EqualityComparer);
                Assert.Equal(-1, idx);
                idx = MemoryExt.LastIndexOfNotEqualAllSourceComparer(span, values, EqualityComparer);
                Assert.Equal(-1, idx);
        ...
        public void MakeSureNoChecksGoOutOfRange()
        {
            for (int length = 0; length < 100; length++)
            {
                ...
                int index = MemoryExt.LastIndexOfNotEqualAllSourceComparer(span, values, EqualityComparer);
                Assert.Equal(-1, index);
                index = MemoryExt.LastIndexOfNotEqualAllSourceComparer(span, values, EqualityComparer);
                Assert.Equal(-1, index);
            }
    ...
    public class ReadOnlySpan_LastIndexOfNotEqualAll_EqualityComparer_int : 
        ReadOnlySpan_LastIndexOfNotEqualAll_EqualityComparer<int>
    {
        public override int NewT(int value) => value;
    }

    public class ReadOnlySpan_LastIndexOfNotEqualAll_EqualityComparer_string :
        ReadOnlySpan_LastIndexOfNotEqualAll_EqualityComparer<string>
    {
