...
{
    public abstract class LastIndexOfEqualAny_EqualityComparer<T>
    {
    ...
    public class LastIndexOfEqualAny_EqualityComparer_int : LastIndexOfEqualAny_EqualityComparer<int>
    {
        public override int NewT(int value) => value;
    }

    public class LastIndexOfEqualAny_EqualityComparer_string : LastIndexOfEqualAny_EqualityComparer<string>
    {
