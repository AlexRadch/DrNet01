...
{
    public abstract class ReadOnlySpan_IndexOfNotEqualAll_EqualityComparer<T>
    {
    ...
    public class ReadOnlySpan_IndexOfNotEqualAll_EqualityComparer_int : ReadOnlySpan_IndexOfNotEqualAll_EqualityComparer<int>
    {
        public override int NewT(int value) => value;
    }

    public class ReadOnlySpan_IndexOfNotEqualAll_EqualityComparer_string : ReadOnlySpan_IndexOfNotEqualAll_EqualityComparer<string>
    {
