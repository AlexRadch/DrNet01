...
{
    public abstract class ReadOnlySpan_LastIndexOfEqual<T, TSource, TValue>
    {
    ...
    public class ReadOnlySpan_LastIndexOfEqual_intEE :
        ReadOnlySpan_LastIndexOfEqual<int, TEquatable<int>, TEquatable<int>>
    {
    ...
    public class ReadOnlySpan_LastIndexOfEqual_intEO :
        ReadOnlySpan_LastIndexOfEqual<int, TEquatable<int>, TObject<int>>
    {
        public override int NewT(int value) => value;
        public override TEquatable<int> NewTSource(int value, Action<int, int> onCompare) =>
            new TEquatable<int>(value, onCompare);
    ...
    public class ReadOnlySpan_LastIndexOfEqual_intOE :
        ReadOnlySpan_LastIndexOfEqual<int, TObject<int>, TEquatable<int>>
    {
        public override int NewT(int value) => value;
    ...
    public class ReadOnlySpan_LastIndexOfEqual_stringEE :
        ReadOnlySpan_LastIndexOfEqual<string, TEquatable<string>, TEquatable<string>>
    {
