...
{
    public abstract class ReadOnlySpan_SequenceEqualToFrom_EqualityComparer<T>
    {
    ...
    public class ReadOnlySpan_SequenceEqualToFrom_EqualityComparer_int: ReadOnlySpan_SequenceEqualToFrom_EqualityComparer<int>
    {
        public override int NewT(int value) => value;
    }

    public class ReadOnlySpan_SequenceEqualToFrom_EqualityComparer_string: ReadOnlySpan_SequenceEqualToFrom_EqualityComparer<string>
    {
